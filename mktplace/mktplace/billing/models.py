...
class Order(models.Model):
    user = models.ForeignKey(User, related_name='order_user', on_delete=models.PROTECT)
    merchant = models.ForeignKey(User, related_name='order_merchant', on_delete=models.PROTECT)
