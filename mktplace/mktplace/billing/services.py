...
class BillingService(object):
    ...
    def transfer(self, order):
        ...
        total = math.ceil(float(order.total) * float(percent_commission)) * 100 #O IUGU só recebe valores em centavos
        ...
        transfer = Transfer().create(data_comission)
        return transfer
